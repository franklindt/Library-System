...
public class UtilTest {
    ...
    private final Hold hold = new Hold(new User("frank", "bridge", 16, "apache attack helicopter", new Date()), new Media(new Date(), "ben", 177013, "british", "kiwi house", 'G', "sol"), new Date(), "hold", false);
     ...
     */
      ...
      */
      ...
      private final Log log = new Log(new User("bob", "5 pineapple lane", 17, "male", new Date()), new Media(new Date(), "yi san", 000000, "West Chinese", "I", 'P', "nice"), new Date(), "a book");
       ...
       */
       ...
       private final ItemStatus itemstatus = new ItemStatus(new User("name", "address", 3, "gender", new Date()), new Media(new Date(), "author", 111111, "language", "publisher", 'a', "genre"), new Date(), "detail", false, 0);
        ...
        */
        ...
        private final Library library = new Library("hillcrest something", new ArrayList<Media>(), "911", 5, "omaygat ambutakum");
         ...
         */
         ...
         private final Handler handler = new Handler(new ArrayList<Hold>(), new ArrayList<Fee>(), new ArrayList<ItemStatus>());
