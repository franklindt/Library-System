...
public class VideoGames extends Media
{
    ...
    public VideoGames(final Date publishDate, final String author, final int SIN, final String language, final String publisher, final Character ageRating, final String genre, final String platform, final String[] peripheralsRequired, final int amtPlayers) {
