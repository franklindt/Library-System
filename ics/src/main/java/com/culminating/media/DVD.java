...
public class DVD extends Media
{
    ...
    public DVD(final Date publishDate, final String author, final int SIN, final String language, final String publisher, final Character ageRating, final String genre, final int streamQuality, final boolean isBluRay, final boolean isAudioOnly) {
